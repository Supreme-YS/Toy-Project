...
# 캐릭터(sprite 스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\dudtj\\Desktop\\Toy-Project\\pygame_basic\\character.png")
...
enemy = pygame.image.load("C:\\Users\\dudtj\\Desktop\\Toy-Project\\pygame_basic\\enemy.png")
